...
function updateUser(user) {
  // Ignore updates that don't have a user ID. For example, pageviews are tracked
  // as events in Intercom for authenticated users (to update the 'last seen')
  // field, but are not tracked in Intercom.
  if (!user || !user.id) {
